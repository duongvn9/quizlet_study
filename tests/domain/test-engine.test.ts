...
describe("test domain", () => {
  ...
  it.each([110, 359])("grades VNR Nhung Hoang question %i as an exact canonical-key set in learn and test modes", (number) => {
    const vnr = adaptVnrFeNhunghoang(vnrNhunghoangData);
