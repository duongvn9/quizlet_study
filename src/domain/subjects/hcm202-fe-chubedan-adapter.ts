...
const rawSchema = z.object({
  ...
  subject: z.object({ code: z.literal("HCM202"), title: z.string().min(1), assessment: z.literal("Final Exam"), collection: z.literal("Chu Be Dan"), language: z.literal("vi") }).passthrough(),
...
export const hcm202FeChubedanRawSchema = z.preprocess((value) => {
...
export function adaptHcm202FeChubedan(value: unknown): Subject {
  const raw = hcm202FeChubedanRawSchema.parse(value);
  ...
  return subjectSchema.parse({
    schemaVersion: 1,
    contentVersion: 1,
    id: "hcm202-fe-chubedan",
    slug: "hcm202-fe-chubedan",
    code: "HCM202",
    name: "HCM202 - Tư tưởng Hồ Chí Minh - Final Exam - Chu Be Dan",
    description: `Bộ ${questions.length} câu hỏi Final Exam môn Tư tưởng Hồ Chí Minh - Chu Be Dan.`,
