...
import subject1 from "../subjects/MLN131_FE_NhungHoang.json";
import subject2 from "../subjects/hcm202_fe_chubedan.json";
import subject3 from "../subjects/hcm202_pt.json";
import subject4 from "../subjects/pmg201c.json";
import subject5 from "../subjects/fe-swd392.json";
import subject6 from "../subjects/mln122.json";
import subject7 from "../subjects/mma301.json";
import subject8 from "../subjects/swd392.json";
...
export const subjects: Subject[] = [adaptHcm202FeNhunghoang(subject0),adaptMln131FeNhunghoang(subject1),adaptHcm202FeChubedan(subject2),adaptHcm202Pt(subject3),adaptPmg201c(subject4),adaptFeSwd392(subject5),adaptMln122(subject6),adaptMma301(subject7),subjectSchema.parse(subject8)];
